...
exercise3 = Exercise(ex_title="Play Along", routine = routine1)
exercise4 = Exercise(ex_title="Broken Thirds", routine=routine2)
exercise5 = Exercise(ex_title="Broken Sixths", routine=routine2)
